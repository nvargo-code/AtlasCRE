  ...
  for (const [dedupeKey, variants] of groups) {
    ...
    const listing = await prisma.listing.upsert({
      ...
      create: {
        ...
        constructionMaterials: master.constructionMaterials,
        hasPool: master.hasPool,
        hasWaterfront: master.hasWaterfront,
        hasView: master.hasView,
        hasGuestAccommodations: master.hasGuestAccommodations,
        hasBoatSlip: master.hasBoatSlip,
